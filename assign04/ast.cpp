...
std::string ASTTreePrint::node_tag_to_string(int tag) const {
  ...
  case AST_FIELD_REF_EXPRESSION: return "AST_FIELD_REF_EXPRESSION";
  case AST_INDIRECT_FIELD_REF_EXPRESSION: return "AST_INDIRECT_FIELD_REF_EXPRESSION";
  case AST_ARRAY_ELEMENT_REF_EXPRESSION: return "AST_ARRAY_ELEMENT_REF_EXPRESSION";
  case AST_ARGUMENT_EXPRESSION_LIST: return "AST_ARGUMENT_EXPRESSION_LIST";
  case AST_VARIABLE_REF: return "AST_VARIABLE_REF";
  case AST_LITERAL_VALUE: return "AST_LITERAL_VALUE";
  case AST_IMPLICIT_CONVERSION: return "AST_IMPLICIT_CONVERSION";
