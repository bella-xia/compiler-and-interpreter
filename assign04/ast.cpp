...
std::string ASTTreePrint::node_tag_to_string(int tag) const
{
  ...
  case AST_STRUCT_TYPE:
    return "AST_STRUCT_TYPE";
  case AST_UNION_TYPE:
    return "AST_UNION_TYPE";
  case AST_BASIC_TYPE:
    return "AST_BASIC_TYPE";
  case AST_DECLARATOR_LIST:
    return "AST_DECLARATOR_LIST";
  case AST_NAMED_DECLARATOR:
    return "AST_NAMED_DECLARATOR";
  case AST_POINTER_DECLARATOR:
    return "AST_POINTER_DECLARATOR";
  ...
  case AST_IF_ELSE_STATEMENT:
    return "AST_IF_ELSE_STATEMENT";
  case AST_STRUCT_TYPE_DEFINITION:
    return "AST_STRUCT_TYPE_DEFINITION";
  case AST_UNION_TYPE_DEFINITION:
    return "AST_UNION_TYPE_DEFINITION";
  case AST_FIELD_DEFINITION_LIST:
    return "AST_FIELD_DEFINITION_LIST";
