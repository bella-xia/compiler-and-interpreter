...
const char *highlevel_opcode_to_str(HighLevelOpcode opcode) {
  ...
  case HINS_spill_b:    return "spill_b";
  case HINS_spill_w:    return "spill_w";
  case HINS_spill_l:    return "spill_l";
  case HINS_spill_q:    return "spill_q";
  case HINS_restore_b:  return "restore_b";
  case HINS_restore_w:  return "restore_w";
  case HINS_restore_l:  return "restore_l";
  case HINS_restore_q:  return "restore_q";
...
int highlevel_opcode_get_source_operand_size(HighLevelOpcode opcode) {
  ...
  case HINS_spill_b: return 1;
  case HINS_spill_w: return 2;
  case HINS_spill_l: return 4;
  case HINS_spill_q: return 8;
  case HINS_restore_b: return 1;
  case HINS_restore_w: return 2;
  case HINS_restore_l: return 4;
  case HINS_restore_q: return 8;
