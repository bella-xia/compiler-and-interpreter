...
public:
  ...
  Instruction(int opcode, const Operand &op1, const Operand &op2, const Operand &op3, const std::vector<std::tuple<Operand, int>> &m_ops, unsigned num_operands = 3);
  ...
  const Operand &get_moperand(unsigned index) const;
